...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { name: @agenda.name, rapper_id: @agenda.rapper_id, resource: @agenda.resource, song: @agenda.song, type_id: @agenda.type_id, video: @agenda.video }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { name: @agenda.name, rapper_id: @agenda.rapper_id, resource: @agenda.resource, song: @agenda.song, type_id: @agenda.type_id, video: @agenda.video }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
